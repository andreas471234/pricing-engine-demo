...
class AddProductSerializer(serializers.Serializer):
    ...
    price_per_unit = serializers.DecimalField(min_value=1000, max_digits=25, decimal_places=4)
...
class ProductPriceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductPrice
        fields = ('id', 'price_per_unit', 'min_qty', 'updated_at', 'created_at', 'supplier_map', 'unit')
...
class SupplierProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'product_code', 'stock', 'product_unit_name', 'created_at', 'prices')
        read_only_fields = ('id', 'created_at')
...
class SupplierDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Supplier
        fields = ('id', 'code', 'name', 'address', 'city', 'state', 'created_at', 'products')
        read_only_fields = ('id', 'created_at')
